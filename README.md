...
# Final Assignment
#### Description: This is a website for user to subscribe article.
...
```bash
https://github.com/hogenjiang/web615-final-assignment-base.git
...
https://hogen-final-project.herokuapp.com/
...
Heroku Postgres provides trusted database options at terabyte scale. Dyno choices to suit your needs, including performance dynos for your highest traffic apps — all scalable in an instant. Heroku keeps the kernel up-to-date with the latest security patches. All backed by the trust and reliability of Salesforce.
